...
@export_group("Stabilizer")
@export_range(0.0, 1.0, 0.01) var stabilization_mix: float = 0.72
@export var stabilization_kp: float = 3.2
@export var stabilization_kd: float = 1.15
@export var yaw_damping: float = 0.55
@export var max_yaw_correction: float = 0.45
@export_range(0.0, 0.5, 0.01) var max_stabilization_throttle: float = 0.22
...
func _integrate_forces(state: PhysicsDirectBodyState3D) -> void:
    ...
    _latest_commands = distribute_power_to_thrusters(_latest_input, _latest_stabilization)
